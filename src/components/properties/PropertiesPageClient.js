                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-2">
                        <StatusBadge status={prop.subscription_status || prop.status} />
                        {prop.payment_required_now && (
                          <svg className="w-3.5 h-3.5 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" title={prop.subscription_message || ''}>
